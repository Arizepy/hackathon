  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        stocked: "border-transparent bg-emerald-500 text-white shadow-sm",
        low: "border-transparent bg-amber-500 text-white shadow-sm",
        out: "border-transparent bg-red-500 text-white shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
